...
function Chatbot() {
    ...
    const generateResponse = (query)=>{
        ...
        // Services Logic
        const matchingService = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$lib$2f$data$2f$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["services"].find((s)=>lower.includes(s.name.toLowerCase()));
        if (matchingService) {
            return `**${matchingService.name}**\n${matchingService.description}`;
        }
        if (lower.includes("service") || lower.includes("support")) {
            return "Here are our available services:\n" + __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$lib$2f$data$2f$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["services"].map((s)=>`• ${s.name}`).join("\n") + "\n\nTell me which service you want details for.";
        }
        // Contact Info
...
//# sourceMappingURL=6c7f9_v0-corporate-website-build-main_v0-corporate-website-build-main_36024408._.js.map