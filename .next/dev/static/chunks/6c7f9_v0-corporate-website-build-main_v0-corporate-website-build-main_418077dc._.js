...
"[project]/Downloads/v0-corporate-website-build-main/v0-corporate-website-build-main/lib/data/services.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$lib$2f$data$2f$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Downloads/v0-corporate-website-build-main/v0-corporate-website-build-main/lib/data/services.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Chatbot() {
    ...
    const generateResponse = (query)=>{
        ...
        // -------------------------------------------------------------
        const serviceMatch = __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$lib$2f$data$2f$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["services"].find((s)=>lower.includes(s.name.toLowerCase()) || lower.split(" ").some((w)=>s.name.toLowerCase().includes(w)));
        if (serviceMatch) {
            return `🛠 **${serviceMatch.name}**\n\n${serviceMatch.description}`;
        }
        // Show services list
        if (lower.includes("service") || lower.includes("support")) {
            return "Here are our services:\n\n" + __TURBOPACK__imported__module__$5b$project$5d2f$Downloads$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$v0$2d$corporate$2d$website$2d$build$2d$main$2f$lib$2f$data$2f$services$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["services"].map((s, i)=>`${i + 1}. ${s.name}`).join("\n") + "\n\nType the service name or number to get full details.";
        }
        // -------------------------------------------------------------
        // 4) CONTACT DETAILS
        // -------------------------------------------------------------
...
_s(Chatbot, "zZREcG92aFI7hb8rq5Kn3rbmIXU=");
_c = Chatbot;
var _c;
...
//# sourceMappingURL=6c7f9_v0-corporate-website-build-main_v0-corporate-website-build-main_418077dc._.js.map